...
otprav("ohelpc('ktoposetil',\"".njs("посетители страницы: $vsego комментариев: $comm")."\",\"<div class=r>".njs(prn_in_col($pp,RE0('col')))
...
// .",a.time_reg,a.timelast"
." FROM `dnevnik_posetil` AS r, ".$db_unic." AS a
WHERE r.url='".$data."' AND a.id=r.unic AND a.admin!='podzamok'"
." AND (a.login != '' OR a.openid !='' OR a.realname != '')"
// ." AND (a.time_reg > ".time("2022-06-29")." AND a.time_reg < ".time("2022-06-30")." )"
." LIMIT 20000","_a");
...
otprav("ohelpc('statistic',\"статистика посещений страницы\",\"".njs($blockblock)."\")");
