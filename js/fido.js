...
if(!fido_lastid || !confirm('Удалить из базы?')) return;
majax('module.php',{mod:'FIDO',a:'msg_admindel',area:are[mya],id:fido_lastid});
}

function msg_new(e) {
if(typeof are[mya] == 'undefined') return salert('Не выбрана эха',1000);
...
setkey('KeyM','',msg_kludge,true);
setkey('KeyR','',msg_reply,true);
setkey('KeyN','',msg_new,true);
setkey('ArrowLeft','',begunok_up,false);
setkey('ArrowRight','',begunok_down,false);
setkey('ArrowUp','',function(){areamove(-1)},false);
setkey('ArrowDown','',function(){areamove(1)},false);
setkey('Delete','',msg_del,false);
}
