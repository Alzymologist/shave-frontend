...
function helpc(id,s) { if(ifid(id)) return sendm("helpc;id="+hl(id)+";s="+hl(s)); helps(id,s); posdiv(id,-1,-1); }
function ohelpc(id,z,s) { if(ifid(id)) return sendm("ohelpc;id="+hl(id)+";z="+hl(z)+";s="+hl(s)); helpc(id,mk_helpbody(z,s)); }
function ohelp(id,z,s) { if(ifid(id)) return sendm("ohelp;id="+hl(id)+";z="+hl(z)+";s="+hl(s)); helps(id,mk_helpbody(z,s)); }
...
function majax(url,a,js,sm){ // alert('majax!');
	...
	if(typeof(hashpage)!='undefined') a.hashpage=hashpage;
        ...
        if(typeof(mylang)!='undefined') a.mylang=mylang;
