...
function GO(){
    nonav=1; domdel('logindiv'); domdel('adminpanel_open'); domdel('adminpanel');
    RZ.screen();
...
screen:function(){
    var e=dom('#bodyz DIV');
    var s="<center><div id='mdiv'>\
\
\
<div class='rinz'>\
<img src='"+pat+"div.webp' style='position:absolute;bottom:0;left:146px;'>\
\
...
<img src='"+pat+"smd.webp' class='smdimg'>\
...
if(typeof(page_onstart)!= "undefined") page_onstart.push("GO()"); // else GO();
