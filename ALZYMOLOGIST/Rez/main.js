...
clean=function(id,animtrue) {
	...
	var clen=function(){var s=idd(id); if(!s) return;
        ...
        else { if(1!=anim(idd(id),'zoomOut',clen,animtrue)) setTimeout(function(){clen()},1500); }
...
function anim(e,i,fn,animeffect) { if(!e) return 1; if(!user_opt('ani')&&!animeffect) { if(fn)fn(); return 1; }
...
// скопировать
cpbuf=function(e){ if(typeof(e)=='object') e=e.innerHTML; // navigator.clipboard.writeText(e);
