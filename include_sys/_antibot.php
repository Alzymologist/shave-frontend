...
return "<img class='centr' src='".$GLOBALS['antibot_www'].$GLOBALS['antibot_hash'].".jpg' width=".$GLOBALS['antibot_imW']." height=".$GLOBALS['antibot_imH']." alt='captcha' style='max-width:none !important;' border=0>";
}
