...
w: "Mo</td><td>Tu</td><td>We</td><td>Th</td><td>Fr</td><td>Sa</td><td>Su"
    ...
    "ru": {
x: "«акрыть", nex: "—ледующий мес€ц", pre: "ѕредыдущий мес€ц", clear: "ќчистить",
m: ["янв","‘ев","ћрт","јпр","ћай","»юн","»юл","јвг","—ен","ќкт","Ќбр","ƒек"],
mo: ["январь","‘евраль","ћарт","јпрель","ћай","»юнь","»юль","јвгуст","—ент€брь","ќкт€брь","Ќо€брь","ƒекабрь"],
w: "ѕн</td><td>¬т</td><td>—р</td><td>„т</td><td>ѕт</td><td>—б</td><td>¬с"
    }
}
var def = {
    lang: "ru", // en/ru
...
HTM(a.id, '<thead><tr><td class="cal-l" title="'+lang[a.lang].pre+'">Л</td><td colspan=3 class="cal-m"></td><td colspan=2 class="cal-y"></td><td class="cal-r" title="'+lang[a.lang].nex+'">Ы</td></tr><tr><td>'+lang[a.lang].w+'</td></tr></thead>');

if(j>0) {// Л &larr;
    if(m==0) mm = 11; else mm = m-1;
    if(j>1) {
	ca += '<td colspan='+j+' class="cal-l" align=left title="'+lang[a.lang].pre+' '+lang[a.lang].mo[mm]+'"><b>Л '+lang[a.lang].m[mm]+'</b></td>';
    } else ca += '<td class="cal-l" title="'+lang[a.lang].pre+' '+lang[a.lang].mo[mm]+'"><b>Л</b></td>';
}
...
if(DNlast>0) {// Ы &rarr;
    ...
    if(DNlast<6) {
	ca += '<td colspan='+(7-DNlast)+' class="cal-r" align=right title="'+lang[a.lang].nex+' '+lang[a.lang].mo[mm]+'"><b>'+lang[a.lang].m[mm]+' Ы</b></td>';
    } else ca += '<td class="cal-r" title="'+lang[a.lang].nex+' '+lang[a.lang].mo[mm]+'"><b>Ы</b></td>';
}
