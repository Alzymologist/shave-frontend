...
'@0'=>"<blockquote class='BC' style='border: 1px dashed rgb(255,0,0); box-shadow: 0px 2px 4px 0px rgba(255,0,0,0.4); background-color: rgb(255,252,223); border-radius: 11px 11px 11px 11px;'>{0}</blockquote>",
...
'cut'=>"<p>=============== cut ===============<br>{0}<br>=============== /cut ===============<p>"
);

function BC_callback($e) {
    if(isset($GLOBALS['PUBL'])) {
	    if(!in_array($GLOBALS['net'],array('telegraph','lj'))) return str_replace('{0}',$e[2],$GLOBALS['BC_table']['cut']);
    }
